#
# Sets PROJECT_VERSION and CPACK_PACKAGE_VERSION
#
...
if (GIT_CMD AND EXISTS "${GIT_TOPLEVEL}")
    ...
    if (GIT_DESCRIBE)
        ...
        execute_process(COMMAND ${GIT_CMD} rev-list --count HEAD
                ...
                OUTPUT_STRIP_TRAILING_WHITESPACE)
        set(CPACK_PACKAGE_VERSION ${PROJECT_VERSION}+${GIT_COMMIT_COUNT}+g${GIT_SHA1})
    endif ()
endif ()
...
if (NOT CPACK_PACKAGE_VERSION)
    message(WARNING "CPACK_PACKAGE_VERSION not set! Did you include project_version.cmake? Falling back to (${PROJECT_VERSION})")
    set(CPACK_PACKAGE_VERSION ${PROJECT_VERSION})
endif ()

version_split(${PROJECT_VERSION} CPACK_PACKAGE_VERSION_MAJOR CPACK_PACKAGE_VERSION_MINOR CPACK_PACKAGE_VERSION_PATCH extra)
